...
int main()
{
	...
	//Vista que tiene la cámara, que tanto puede ver
	glm::mat4 projection = glm::perspective(camera.GetZoom(), (GLfloat)SCREEN_WIDTH / (GLfloat)SCREEN_HEIGHT, 0.1f, 2500.0f);
